        ...
        if(filePath != null) {
            ...
            uploadTask.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                            ...
                            public void onComplete(@NonNull Task<Uri> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    // ...
                                    String errMsg = task.getException().getMessage();
                                    Toast.makeText(getApplicationContext(), "Erreur d'URI de téléchargement : " + errMsg, Toast.LENGTH_LONG).show();
                                    progressDoalog.dismiss();
                                }
                            }
                        });
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(getApplicationContext(), "Échec du téléchargement : " + e, Toast.LENGTH_LONG).show();
                    progressDoalog.dismiss();
                }
            });
        }
        else {
            Toast.makeText(getApplicationContext(), "Veuillez sélectionner l'image du produit", Toast.LENGTH_SHORT).show();
            progressDoalog.dismiss();
        }
    }
