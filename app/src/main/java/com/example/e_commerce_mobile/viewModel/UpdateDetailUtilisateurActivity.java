...
public class UpdateDetailUtilisateurActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_detail_utilisateur);
        ...
        toolbar.setTitle("Information sur la mise à jour");
